...
class Command(BaseCommand):
    ...
    def export_geojson(self, query, target_file):
        ...
        # The `created` datetime uses the suffix "Z" instead of "+00:00"
        # as generated by Python to indicate that this time is in the UTC timezone
        # and not merely with a zero-offset from the UTC timezone. It seems pointless
        # but when the file is re-imported, LayerMapping detects the correct timezone
        # from this format and not from the one that Python is exporting.
            ...
            results["features"].append(
                {
                    ...
                    "properties": {
                        ...
                        "created": report.created_date.isoformat().replace(
                            "+00:00", "Z"
                        ),
